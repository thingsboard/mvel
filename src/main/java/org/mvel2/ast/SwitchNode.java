...
public class SwitchNode extends BlockNode implements NestedStatement {
  ...
  protected SwitchNode elseIf;
  protected ExecutableStatement elseBlock;

  protected boolean idxAlloc = false;

  public SwitchNode(char[] expr, int start, int offset, int blockStart, int blockOffset, int fields, ParserContext pCtx) {
    super(pCtx);
  ...
  public SwitchNode setCase(SwitchNode elseIf) {
